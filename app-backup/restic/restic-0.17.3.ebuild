...
SRC_URI="https://github.com/restic/restic/tarball/39a6124be558622b0473175af5f8062f3bdca488 -> restic-0.17.3-39a6124.tar.gz
https://direct-github.funmore.org/ac/d3/0c/acd30c6bcc48bdd1100bad9c57e7455d7d66196ddc6b06b88affb97a9f88e8f568b50051b334c995c2814e91618a8eb048dfc40bd231e551f52cc50327ac1ed8 -> restic-0.17.3-funtoo-go-bundle-dabbce6487c9ea6d9ccb13b297b4273d713b23388571f8bb222155f21674e4df1c9b1dfd084b8f9617f8018fdacf1ec9d2e50108d09f691247f1d94a6bbd1caa.tar.gz"
...
src_compile() {
	go build -ldflags '-X main.version=0.17.3' \
		-asmflags "-trimpath=${S}" \
		-gcflags "-trimpath=${S}" \
		-o restic ./cmd/restic
}
