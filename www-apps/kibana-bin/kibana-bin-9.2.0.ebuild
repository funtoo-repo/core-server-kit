...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/kibana/kibana-9.2.0-linux-x86_64.tar.gz -> kibana-9.2.0-linux-x86_64.tar.gz )
	arm64? ( https://artifacts.elastic.co/downloads/kibana/kibana-9.2.0-linux-aarch64.tar.gz -> kibana-9.2.0-linux-aarch64.tar.gz )
"
