...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/kibana/kibana-8.18.4-linux-x86_64.tar.gz -> kibana-8.18.4-linux-x86_64.tar.gz )
	arm64? ( https://artifacts.elastic.co/downloads/kibana/kibana-8.18.4-linux-aarch64.tar.gz -> kibana-8.18.4-linux-aarch64.tar.gz )
"
...
pkg_postinst() {
	...
	elog "Node.js 20. Some plugins may fail with other versions of Node.js"
	elog
