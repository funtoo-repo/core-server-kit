...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/kibana/kibana-9.2.1-linux-x86_64.tar.gz -> kibana-9.2.1-linux-x86_64.tar.gz )
	arm64? ( https://artifacts.elastic.co/downloads/kibana/kibana-9.2.1-linux-aarch64.tar.gz -> kibana-9.2.1-linux-aarch64.tar.gz )
"
