...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/logstash/logstash-9.1.3-linux-x86_64.tar.gz -> logstash-9.1.3-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/logstash/logstash-9.1.3-linux-aarch64.tar.gz -> logstash-9.1.3-linux-aarch64.tar.gz )
"
