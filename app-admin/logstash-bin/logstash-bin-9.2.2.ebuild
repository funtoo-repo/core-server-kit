...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/logstash/logstash-9.2.2-linux-x86_64.tar.gz -> logstash-9.2.2-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/logstash/logstash-9.2.2-linux-aarch64.tar.gz -> logstash-9.2.2-linux-aarch64.tar.gz )
"
