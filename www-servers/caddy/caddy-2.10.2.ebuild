...
EGO_SUM=(
	...
	"github.com/!kim!machine!gun/automemlimit v0.7.4"
	"github.com/!kim!machine!gun/automemlimit v0.7.4/go.mod"
	...
	"github.com/caddyserver/certmagic v0.24.0/go.mod"
	...
	"github.com/libdns/libdns v1.1.0/go.mod"
	...
	"github.com/mholt/acmez/v3 v3.1.2/go.mod"
	...
	"github.com/quic-go/quic-go v0.54.0/go.mod"
	...
	"github.com/tailscale/tscert v0.0.0-20240608151842-d3f834017e53/go.mod"
	...
	"go.opentelemetry.io/contrib/propagators/autoprop v0.62.0/go.mod"
	"go.opentelemetry.io/contrib/propagators/aws v1.37.0"
	"go.opentelemetry.io/contrib/propagators/aws v1.37.0/go.mod"
	"go.opentelemetry.io/contrib/propagators/b3 v1.37.0"
	"go.opentelemetry.io/contrib/propagators/b3 v1.37.0/go.mod"
	"go.opentelemetry.io/contrib/propagators/jaeger v1.37.0"
	"go.opentelemetry.io/contrib/propagators/jaeger v1.37.0/go.mod"
	"go.opentelemetry.io/contrib/propagators/ot v1.37.0"
	"go.opentelemetry.io/contrib/propagators/ot v1.37.0/go.mod"
	...
	"golang.org/x/crypto/x509roots/fallback v0.0.0-20250305170421-49bf5b80c810/go.mod"
...
SRC_URI="https://github.com/caddyserver/caddy/tarball/2800fc8b6f56bcfe7200692bb1b94706771338ed -> caddy-2.10.2-2800fc8.tar.gz
https://direct-github.funmore.org/54/ae/1d/54ae1daf0c69581b1dad4ae7f7f2cbbdcb6fbe42a51c6b4b3865112f881636c8c8995648d6fc71f01b08fde0bae7338a7a49ef38fb1bcf4a6acaca7fb2710027 -> caddy-2.10.2-funtoo-go-bundle-ec154d8e84aa6e2ac9e7a81979a66d02522173abb0e6eaa48a034987aee1dad6cdcefc64f81fa56c6ee21454f0dbc486609e5d6e1bb0a7eb33ae59f62a5d1ddb.tar.gz"
...
src_compile() {
	go build -ldflags '-X github.com/caddyserver/caddy/v2.CustomVersion=v2.10.2-2800fc8-funtoo' \
