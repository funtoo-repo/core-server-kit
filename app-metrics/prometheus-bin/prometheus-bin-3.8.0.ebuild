...
SRC_URI="amd64? (
  https://github.com/prometheus/prometheus/releases/download/v3.8.0/prometheus-3.8.0.linux-amd64.tar.gz -> prometheus-3.8.0.linux-amd64.tar.gz
)
arm64? (
  https://github.com/prometheus/prometheus/releases/download/v3.8.0/prometheus-3.8.0.linux-arm64.tar.gz -> prometheus-3.8.0.linux-arm64.tar.gz
)
"
