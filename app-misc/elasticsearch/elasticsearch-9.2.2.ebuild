...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-9.2.2-linux-x86_64.tar.gz -> elasticsearch-9.2.2-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-9.2.2-linux-aarch64.tar.gz -> elasticsearch-9.2.2-linux-aarch64.tar.gz )
"
